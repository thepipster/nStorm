...
Logger.infoX("LightningApp", "Version " + pjson.version);
...
process.on('SIGTERM', function () {
    Logger.infoX("LightningApp", "Closing"); app.close();
});

http.createServer(app).listen(app.get('port'), function(){
    Logger.infoX("LightningApp", "Express HTTP server listening on port " + app.get('port'));
});
