            ...
            if (cluster.isMaster) {
                ...
                if (typeof block.process !== 'undefined'){
                    ...
                    */
                    ...
                    setInterval(_checkThreads, 1000);
                    setInterval(_processLostMessages, 1000);
                }


                function _doProcess(msg){
                ...
                */
                function _checkThreads(){
                    for (var i=0; i<block.threads.length; i++){
                        client.exists(block.threads[i], function(err, val){
                            if (!val) _clearThread(block.threads[i]);
                        })
                    }
                }
                                ...
                                if (msgId){
                                    ...
                                    client.get("msg-"+msgId, function(err, msgString){
                                        ...
                                        if (msgString){
                                            ...
                                            //Logger.warn("[" + blockName + "] Re-processing old message ", msg);
                                            _doProcess(msg);                         
                                        }
